...
Unfortuntely, the Arduino IDE is about 30 years behind the times. It looks like an application written in the 1990s and doesn't have the features you would expect a modern program to have. That said, it does reliably work.
...
Using those instructions, go ahead and install the Arduino IDE.
