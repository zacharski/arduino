...
In this code, setup consists of a single line:
...
First, anytime the Arduino IDE running on your laptop detects a // it interprets from there to the end of the line as a comment and is not sent to the Arduino Uno board. So "// turn on the LED" is intended for us as a helpful comment. To the Arduino the following three lines are treated identically:

```
        digitalWrite(13, HIGH);      // turn on the LED
        digitalWrite(13, HIGH);
        digitalWrite(13, HIGH);      // I hope this works
...
Go ahead and save your program if you haven't done so already.
