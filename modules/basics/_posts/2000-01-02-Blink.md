...
Each experiment will have an associated diagram.

Connect the components to the breadboard and Arduino Uno by using the diagram below.

![](/arduino/img/basicLedFzz.png)
